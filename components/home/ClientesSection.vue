...
.display-text {
  font-size: clamp(2.5rem, 3.5vw, 6.5rem); /*corregido*/
...
.carousel-caption {
  position: static; /* Quitamos el posicionamiento absoluto de bootstrap */
  display: flex;
...
.user-image {
  ...
  object-fit: cover;
  margin-right: 10px;
  /* Aplicamos el mismo efecto de borde y espaciado que en las miniaturas */
  padding: 3px;
...
#custCarousel .carousel-indicators > li {
  width: 100px;
  height: 100px; /* Aseguramos que el contenedor sea cuadrado para un círculo perfecto */
...
@media (max-width: 768px) {
  ...
  .testimonial-card {
    ...
    padding: 1.5rem; /* Un poco menos de padding */
    background-image: var(--bg-mobile); /* En móviles usa la imagen móvil */
