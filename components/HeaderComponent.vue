...
const headerClasses = computed(() => {
  ...
  return {
    ...
    'header-solid-bg': !isHome, // Aplica fondo sólido si NO es el home
  };
});
...
<template>
  <header class="fixed-top transition-header" :class="headerClasses">
    <!-- Barra de Navegacion -->
...
.header-scrolled {
  background-color: #000; /* Vuelve a ser negro al hacer scroll */
  box-shadow: 0 4px 6px rgba(0, 0, 0, 0.3);
  padding-top: 0 !important; /* Opcional: hace el header más compacto al bajar */
...
/* Clase para forzar el color de fondo en vistas que no son Home */
.header-solid-bg {
