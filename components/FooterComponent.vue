...
// Si tienes el componente de WhatsApp, descomenta la siguiente línea:
...
<template>
  ...
  <div ref="spacerRef" class="footer-spacer"></div>

  <!-- Footer Fijo: Se queda quieto al fondo y es revelado por el scroll -->
  <footer ref="footerRef" class="site-footer footer-color text-white text-center">
    <div class="container h-100 d-flex flex-column justify-content-center">
      ...
      <div class="row justify-content-center mb-4">
        <div class="col-12">
          ...
          <h2 ref="cascadeTextRef" class="cascade-text m-0">
      ...
      <div ref="footerDetailsRef" class="footer-details">
        <div class="row justify-content-center">
          <div class="col-12">
            <h2 class="footer-subtitle m-0 mb-4">AGENCIA CREATIVA</h2>
            <!-- Links de Navegación -->
...
.site-footer {
  ...
  display: flex;
  align-items: center;
  /* Aseguramos una altura mínima para que luzca bien el efecto */
  min-height: 50vh;
}
...
.footer-spacer {
  position: relative;
  z-index: 1; /* Al nivel del contenido para empujar el scroll */
